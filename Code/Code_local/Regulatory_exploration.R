Packages <- c("ggplot2", "dplyr", "ggplot2", "org.Hs.eg.db", "readr", "neat", "doParallel", "igraph", "tictoc", "plotly");lapply(Packages, library, character.only = TRUE);rm(Packages)
tic()
...
nrow(brain_adult) * 0.5 # Taking only the 2.5% of interactions sums up 29032 edges which is almost the same as the metabosignal inetractions
